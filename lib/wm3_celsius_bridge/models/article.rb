...
module Wm3CelsiusBridge
  ...
  class Article < Dry::Struct
    ...
    attribute :stockout_warning, Types::Params::Bool # ["0", "1"]. No blanks.
    attribute :prevent_negative_inventory, Types::Params::Bool # ["0", "1"]. No blanks.
    attribute :costing_method, Types::Coercible::Integer # ["0", "3"]. No blanks.
    ...
    attribute :price_profit_calculation, Types::Coercible::Integer # # ["0"]. No blanks.
    ...
    attribute :model, Types::Coercible::Integer.optional # # ["3"]. Lots of blanks (only two non-blanks).
